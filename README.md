...
- `docs/data_quality_report_fa.md`: کیفیت و محدودیت برچسب‌های استپ ۹A
- `docs/user_action_required_fa.md`: داده‌ها و اقدامات میدانی/رسمی موردنیاز کاربر
- `outputs/validation/user_action_required.json`: manifest ماشینی ورودی‌های مفقود و مسئولیت تهیه
- `data/labels/labels_step09_normalized.csv`: نمای نرمال‌شدهٔ برچسب‌ها؛ دادهٔ خام تغییر نکرده است
